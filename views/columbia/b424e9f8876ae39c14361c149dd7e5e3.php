...
<body>
					...
					<select name="ext_wall_material_menu[]" multiple="multiple" class="selectMenu[]" placeholder="ext_wall_material">
			...
			<br>
			<select name="nbr_kitchens_menu[]" multiple="multiple" class="selectMenu[]" placeholder="nbr_kitchens">
			...
			<br>
			<select name="nbr_full_baths_menu[]" multiple="multiple" class="selectMenu[]" placeholder="nbr_full_baths">
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="3">3</option>
						<option value="4">4</option>
			...
			<br>
			<select name="nbr_bed_menu[]" multiple="multiple" class="selectMenu[]" placeholder="nbr_bed">
						<option value="3">3</option>
						<option value="1">1</option>
						<option value="4">4</option>
						<option value="7">7</option>
			...
			<br>
			<select name="nbr_fireplaces_menu[]" multiple="multiple" class="selectMenu[]" placeholder="nbr_fireplaces">
						<option value="0">0</option>
						<option value="2">2</option>
						<option value="1">1</option>
						<option value="7">7</option>
			...
			<br>
			<select name="central_air_menu[]" multiple="multiple" class="selectMenu[]" placeholder="central_air">
						<option value="0">0</option>
						<option value="1">1</option>
			</select>
			<br>
			<select name="bsmnt_garage_capacity_menu[]" multiple="multiple" class="selectMenu[]" placeholder="bsmnt_garage_capacity">
						<option value="0">0</option>
						<option value="2">2</option>
						<option value="1">1</option>
						<option value="4">4</option>
			...
			<br>
			<select name="grade_adj_pct_menu[]" multiple="multiple" class="selectMenu[]" placeholder="grade_adj_pct">
						<option value="0">0</option>
			...
			<br>
			<select name="sqft_living_area_menu[]" multiple="multiple" class="selectMenu[]" placeholder="sqft_living_area">
						...
						<option value="12588">12588</option>
						...
						<option value="13604">13604</option>
			...
			<br>
			<select name="bldg_style_menu[]" multiple="multiple" class="selectMenu[]" placeholder="bldg_style">
						<option value="08">08</option>
						<option value="01">01</option>
						<option value="15">15</option>
						<option value="10">10</option>
			...
			<br>
			<select name="heat_type_menu[]" multiple="multiple" class="selectMenu[]" placeholder="heat_type">
						<option value="3">3</option>
						<option value="2">2</option>
						<option value="1">1</option>
						<option value="4">4</option>
			...
			<br>
			<select name="fuel_type_menu[]" multiple="multiple" class="selectMenu[]" placeholder="fuel_type">
						<option value="2">2</option>
						<option value="1">1</option>
						<option value="3">3</option>
						<option value="4">4</option>
			...
			<br>
			<select name="yr_remodeled_menu[]" multiple="multiple" class="selectMenu[]" placeholder="yr_remodeled">
						<option value="0">0</option>
						<option value="2013">2013</option>
						<option value="2014">2014</option>
						<option value="2006">2006</option>
			...
			<br>
			<select name="kitchen_qual_menu[]" multiple="multiple" class="selectMenu[]" placeholder="kitchen_qual">
						<option value=""></option>
						<option value="4">4</option>
						<option value="3">3</option>
						<option value="5">5</option>
			...
			<br>
			<select name="interior_cond_menu[]" multiple="multiple" class="selectMenu[]" placeholder="interior_cond">
						<option value=""></option>
						<option value="4">4</option>
						<option value="3">3</option>
						<option value="2">2</option>
			...
			<br>
			<select name="exterior_cond_menu[]" multiple="multiple" class="selectMenu[]" placeholder="exterior_cond">
						<option value="3">3</option>
						<option value="4">4</option>
						<option value=""></option>
						<option value="2">2</option>
			...
			<br>
			<select name="bath_qual_menu[]" multiple="multiple" class="selectMenu[]" placeholder="bath_qual">
						<option value=""></option>
						<option value="4">4</option>
						<option value="3">3</option>
						<option value="5">5</option>
			...
			<br>
			<select name="nbr_half_baths_menu[]" multiple="multiple" class="selectMenu[]" placeholder="nbr_half_baths">
						<option value="0">0</option>
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="5">5</option>
			...
			<br>
			<select name="first_story_menu[]" multiple="multiple" class="selectMenu[]" placeholder="first_story">
			...
			<br>
			<select name="second_story_menu[]" multiple="multiple" class="selectMenu[]" placeholder="second_story">
						<option value="646">646</option>
						<option value="1054">1054</option>
						<option value="960">960</option>
						<option value="480">480</option>
			...
			<br>
			<select name="addl_story_menu[]" multiple="multiple" class="selectMenu[]" placeholder="addl_story">
						<option value="0">0</option>
						<option value="1200">1200</option>
						<option value="1064">1064</option>
						<option value="1360">1360</option>
			...
			<br>
			<select name="half_story_menu[]" multiple="multiple" class="selectMenu[]" placeholder="half_story">
						<option value="0">0</option>
						<option value="801">801</option>
						<option value="476">476</option>
						<option value="624">624</option>
			...
			<br>
			<select name="three_qtr_story_menu[]" multiple="multiple" class="selectMenu[]" placeholder="three_qtr_story">
						<option value="0">0</option>
						<option value="338">338</option>
						<option value="567">567</option>
						<option value="510">510</option>
			...
			<br>
			<select name="finished_over_garage_menu[]" multiple="multiple" class="selectMenu[]" placeholder="finished_over_garage">
						<option value="0">0</option>
						<option value="312">312</option>
						<option value="640">640</option>
						<option value="250">250</option>
			...
			<br>
			<select name="finished_attic_menu[]" multiple="multiple" class="selectMenu[]" placeholder="finished_attic">
						<option value="0">0</option>
						<option value="374">374</option>
						<option value="400">400</option>
						<option value="650">650</option>
			...
			<br>
			<select name="finished_bsmnt_menu[]" multiple="multiple" class="selectMenu[]" placeholder="finished_bsmnt">
						<option value="0">0</option>
						<option value="1600">1600</option>
						<option value="841">841</option>
						<option value="720">720</option>
			...
			<br>
			<select name="unfinished_half_story_menu[]" multiple="multiple" class="selectMenu[]" placeholder="unfinished_half_story">
						<option value="0">0</option>
						<option value="476">476</option>
						<option value="624">624</option>
						<option value="360">360</option>
			...
			<br>
			<select name="unfinished_3_qtr_story_menu[]" multiple="multiple" class="selectMenu[]" placeholder="unfinished_3_qtr_story">
						<option value="0">0</option>
						<option value="1017">1017</option>
						<option value="516">516</option>
						<option value="661">661</option>
			...
			<br>
			<select name="unfinished_room_menu[]" multiple="multiple" class="selectMenu[]" placeholder="unfinished_room">
						<option value="0">0</option>
						<option value="498">498</option>
						<option value="360">360</option>
						<option value="688">688</option>
			...
			<br>
			<select name="finished_recroom_menu[]" multiple="multiple" class="selectMenu[]" placeholder="finished_recroom">
						<option value="0">0</option>
						<option value="144">144</option>
						<option value="704">704</option>
						<option value="1200">1200</option>
			...
			<br>
			<select name="nbr_rooms_menu[]" multiple="multiple" class="selectMenu[]" placeholder="nbr_rooms">
						<option value="0">0</option>
						<option value="9">9</option>
						<option value="3243">3243</option>
						<option value="4">4</option>
			...
			<br>
			<select name="unfin_over_garage_menu[]" multiple="multiple" class="selectMenu[]" placeholder="unfin_over_garage">
						<option value="0">0</option>
						<option value="768">768</option>
						<option value="312">312</option>
						<option value="797">797</option>
			...
			<br>
			<select name="fireplace_type_menu[]" multiple="multiple" class="selectMenu[]" placeholder="fireplace_type">
						<option value=""></option>
						<option value="1">1</option>
						<option value="2">2</option>
			</select>
